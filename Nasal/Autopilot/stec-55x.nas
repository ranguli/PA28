...
# Output to Garmin G5
var g5_out	=	props.globals.initNode("/instrumentation/G5/ap_out/");
var ap_annun	=	g5_out.initNode("ap", "", "STRING");
var vert_annun	=	g5_out.initNode("vert", "", "STRING");
var lat_annun	=	g5_out.initNode("lat", "", "STRING");
...
var ITAF = {
	...
	loop: func() {		
		...
		vert_annun.setValue(mode_vert);
		lat_annun.setValue(mode_lat);
